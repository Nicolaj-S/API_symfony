 ...
 */
final class Version20220221164037 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE genre DROP FOREIGN KEY FK_835033F853F590A4');
        $this->addSql('DROP INDEX IDX_835033F853F590A4 ON genre');
        $this->addSql('ALTER TABLE genre DROP movies_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE genre ADD movies_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE genre ADD CONSTRAINT FK_835033F853F590A4 FOREIGN KEY (movies_id) REFERENCES movie (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('CREATE INDEX IDX_835033F853F590A4 ON genre (movies_id)');
    }
}
